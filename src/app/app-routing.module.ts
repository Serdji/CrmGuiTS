...
const routes: Routes = [
    { path: '', loadChildren: () => import('./page/login/login.module').then(m => m.LoginModule) , data: { title: 'Авторизация' } },
    {
      ...
      children: [
        ...
        { path: 'add-custom-segmentation', loadChildren: () => import('./page/custom-segmentation/add-custom-segmentation/add-custom-segmentation.module').then(m => m.AddCustomSegmentationModule), data: { title: 'MENU.CUSTOM_SEGMENTATION.ADD_SEGMENTATION' } },
